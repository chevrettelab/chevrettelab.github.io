...
a|image::/mc_assets/team/Gil.jpeg[Javier, {headshot_size}, {headshot_size}]
a|*Javier Gil* +
Javier is pursuing a Chemical and Biomolecular Engineering major. In conjunction with Florida International University, Javier coauthored a research project to mitigate marine toxins by applying microbiological techniques. He has obtained certifications from Miami Dade College School of Science in communicating research findings, laboratory hazards, and responsible conduct of biomedical research. Javier was one of the eight students in Florida to receive the prestigious Jack Kent Cooke Scholarship, which will fund his undergraduate studies at the Massachusetts Institute of Technology. After graduating, he hopes to obtain a Professional Engineer license and continue to show his commitment to his field of study through research projects.

image:/mc_assets/icons/email.png[email, {icon_size}, {icon_size}, link=mailto:Jaiver.gil002@mymdc.net]
